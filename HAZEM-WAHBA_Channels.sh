...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/612/refs/heads/main/channels_backup_OpenBlackhole_20251206_HAZEM-CIEFP.tar.gz"
